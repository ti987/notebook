...
var bkElement=bkClass.extend({
    ...
    setStyle:function(A){
        ...
        for(var C in A){
            switch(C){
            case"float":B.cssFloat=B.styleFloat=A[C];
                break;
...
var nicEditorConfig = bkClass.extend({
    buttons : {
        ...
        //                'encrypt' : {name : __('Click to Encrypt'), command : 'encrypt', tags : ['ENCRYPT'],  key : 'encrypt'},
        'hr' : {name : __('Horizontal Rule'), command : 'insertHorizontalRule', noActive : true}
    },
    iconsPath : '../nicEditorIcons.gif',
    buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','indent','outdent','image','upload','link','unlink','forecolor','bgcolor'],
    iconList : {"bgcolor":1,"forecolor":2,"bold":3,"center":4,"hr":5,"indent":6,"italic":7,"justify":8,"left":9,"ol":10,"outdent":11,"removeformat":12,"right":13,"save":24,"strikethrough":15,"subscript":16,"superscript":17,"ul":18,"underline":19,"image":20,"link":21,"unlink":22,"close":23,"arrow":25,"encrypt":26}
});
;
...
var nicLinkButton=nicEditorAdvancedButton.extend(
    {addPane:function(){
        ...
        this.addForm({"":{type:"title", txt:"Add/Edit Link"},
     ...
     submit:function(C){
         ...
         if(this.ln){
             this.ln.setAttributes({href:this.inputs.href.value,
...
var nicImageButton=nicEditorAdvancedButton.extend( {
    ...
    submit:function(B){
        ...
        if(this.im){
            this.im.setAttributes({src:this.inputs.src.value,
